...
Unfortunately, at time of writing Claude Auto Mode is only available on first-party Anthropic inference, or third-party
inference (e.g., Amazon Bedrock) with limited model support. E.g., if your main session using Sonnet or Opus <4.7, Auto
Mode is not available. This classifier is a local reimplementation  of Auto Mode's transcript-classifier layer, giving
