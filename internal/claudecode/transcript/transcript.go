...
// RawBlock is one element of a message content array. `tool_result` inner fields aren't decoded — they're noise for any
// current consumer.
...
// RawAttachment carries the small subset of transcript attachment fields the classifier cares about. Most attachments
// are framework metadata; queued_command is the user-message replay path Claude Code includes in auto-mode transcripts.
