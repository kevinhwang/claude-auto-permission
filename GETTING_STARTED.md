...
|-----------------------------------|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| `TWO_STAGE_MODE_BOTH` *(default)* | Stage 1 streams XML to a quick yes/no; on `yes`, stage 2 escalates to chain-of-thought for the authoritative reason. | Best balance of correctness and latency. Matches official Auto Mode's production default.               |
